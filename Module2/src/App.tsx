...
export default function App() {
  ...
  const createSender = async () => {
    ...
    const balPubKey = newPair.publicKey;
    ...
    console.log('Sender account: ', publicKey);
    ...
    console.log('Wallet Balance: ' + (await connection.getBalance(balPubKey)) / LAMPORTS_PER_SOL);
  }
